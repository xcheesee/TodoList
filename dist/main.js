...
function showNotesForm(event) {
    ...
    const datepicker = new vanillajs_datepicker_Datepicker__WEBPACK_IMPORTED_MODULE_1__["default"](document.querySelector('#dueD'), {
        autohide: true,
        format: 'dd/mm/yyyy'
    })
...
const makeDomObject = (() => {
    ...
    const makeNote = ({title, desc, dueD, priority, dataId}) => {
    ...
    return {makeSelect, makeInput, makeNote, makeBtn, makeForm, makeLabel, node}
})();
